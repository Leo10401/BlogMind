                    ...
                    <div className=" grid flex-wrap grid-cols-3 gap-4 -m-4">
                        {
                            Listcomp.map((comp, index) => (
                                <div className="p-4 lg:w-1/3 col-span-1" key={index}>
                                   <>
                                    <Link href={'/viewcompetition/'+comp._id} className="cards bg-[#dcffe8] shadow-[0px_4px_16px_px_#367E08]  h-[400px] w-[400px] group gap-[0.5em] rounded-[1.5em] relative flex justify-end flex-col p-[1.5em] z-[1] overflow-hidden" 
                                    >
                                        ...
                                        <div className="contain text-black z-[2] relative font-nunito flex flex-col gap-[0.5em] ">
                                            ...
                                            <div className="h-fit w-full">       
                                                ...
                                                <h1 style={{ fontWeight: 900, WebkitTextFillColor: 'transparent', WebkitTextStrokeWidth: 1 }} className="cards_heading text-[1.5em] tracking-[.2em]">
                                                    {comp.title}
                                                </h1>
